            ...
            <div className="container-fluid inicio">
                ...
                <div className="row align-items-center inicio">
                    ...
                    <div className="col">
                        ...
                        <div className='row'>
                            <div className='col'>
                                <input type='password' className={(!this.state.password.length && this.state.submit) ? 'campos rojo' : 'campos'} placeholder="password..." value={this.state.password} name='password' onChange={this.handleChange}/>
                            </div>
                        </div>
